...
function tinhTong_soDuong() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result1").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
...
function dem_soDuong() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result2").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
        var count = 0;
...
function tim_Min() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result3").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
...
function tim_duongMin() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result4").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
...
function timSo_chanCuoi() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result5").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
...
function doiCho() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result6").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
        var viTri1 = document.getElementById("viTri1").value
        var viTri2 = document.getElementById("viTri2").value
...
function sapXep_tangDan() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result7").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
...
function timSo_nguyenTo() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result8").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
        for (var i = 0; i < arr.length; i++) {  //duyệt mảng
            var So_nguyenTo = 0;
...
/** ý tưởng:  
 * cho user nhập vào số lượng phần tử cần tạo.
 * dùng công thức tạo số ngẫu nhiên trong khoảng Min-Max = Math.random() * (Max - Min) + Min) để tạo 1 số gán vào mảng
 * tạo 1 số ngẫu nhiên: random từ 1 đến soPhanTu: random = Math.round(Math.random() * (soPhanTu - 1) + 1)
 * => mảng sẽ có 'random' số nguyên và 'soPhanTu - random' số thực
 */
    var random = Math.round(Math.random() * (soPhanTu - 1) + 1) //lặp 'random' lần
    for (var i = 0; i < random; i++){
        var Num1_random = Math.round(Math.random() * (100 + 100) - 100); //Tạo số nguyên ngẫu nhiên trong khoảng -100 đến 100 
        B9_arr.push(Num1_random)
    }
    for (var i = 0; i < soPhanTu - random ; i++){ //lặp 'soPhanTu - random' lần để tạo cho đủ số lượng phần tử còn lại
        var Num2_random = (Math.random() * (100 + 100) - 100).toFixed(2); //Tạo số thực ngẫu nhiên từ -100 đến 100, 
...
function soSanh_soLuong() {
    ...
    if (arr.length == 0) {
        ...
        document.getElementById("result10").innerHTML = "Mảng rỗng, vui lòng thử <a href='#soPhanTu'>tạo mảng nhanh</a> và thử lại!"
    } else {
        //mảng không rỗng bắt đầu tính toán
        var soDuong = 0;
        var arr_soDuong = []
